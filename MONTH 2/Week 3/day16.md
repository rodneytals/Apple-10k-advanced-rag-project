...
**Attaching a checkpointer is one line, and nothing else in your nodes has to change**
```python
...
**The Checkpoint Inspector: looking directly at what got saved**
```python
...
**Simulating a crash on purpose, using a genuinely clever Python trick**
```python
