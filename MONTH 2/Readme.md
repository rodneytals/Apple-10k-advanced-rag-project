...
Twenty-five days, four weeks, one running project: turning a single Apple 10-K document into a system that can use tools, reason step by step, catch its own mistakes, run as a checkpointed graph, and remember who you are across separate conversations.
...
📄 **Want the whole month in one document?** See [`My Month 2 Journey.pdf`](./My%20Month%202%20Journey.pdf) for a single, illustrated, line-by-line walkthrough of all 25 days.
