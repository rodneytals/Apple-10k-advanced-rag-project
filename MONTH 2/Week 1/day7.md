...
The second question; asking to compare my own stored historical numbers to a more recent published figure — needed both tools, and here's the real trace of what happened:
```
--- Loop iteration 1 ---
